...
struct StartQuest: View {
    ...
    var body: some View {
            ...
            .hidden()
        NavigationLink(destination: CompleteQuest(quest: quest, showSignInView: $showSignInView, playerInfo: $playerInfo, timer: timer, questImage: Image(uiImage: quest.image)), isActive: $navigateForward){
            }
            .hidden()
